"""
Script: train_liver.py
Purpose: Train a RandomForestRegressor for liver donor–patient match scoring.
Author: Your Name
Date: 2025-12-19
...
- Evaluates with MAE
- Saves model to ../models/liver_model.joblib
"""
...
df = pd.read_csv(os.path.join(data_dir, 'liver.csv')).sample(n=100_000, random_state=42)
...
# 6. Save model
model_path = os.path.join(model_dir, 'liver_model.joblib')

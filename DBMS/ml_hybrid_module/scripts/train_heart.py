...
Purpose: Train a RandomForestRegressor for heart donor–patient match scoring.
Author: Your Name
Date: 2025-12-19
...
- Evaluates with MAE
- Saves model to ../models/heart_model.joblib
"""
...
df = pd.read_csv(os.path.join(data_dir, 'heart.csv')).sample(n=100_000, random_state=42)

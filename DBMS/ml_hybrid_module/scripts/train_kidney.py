"""
Script: train_kidney.py
Purpose: Train a RandomForestRegressor for kidney donor–patient match scoring.
Author: Your Name
Date: 2025-12-19
...
- Evaluates with MAE
- Saves model to ../models/kidney_model.joblib
"""
...
df = pd.read_csv(os.path.join(data_dir, 'kidney.csv')).sample(n=100_000, random_state=42)
...
# 6. Save model
model_path = os.path.join(model_dir, 'kidney_model.joblib')
